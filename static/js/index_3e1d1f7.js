...
a||t.triggerByOcr||A?C.clearAndHideSug():_.getByte(n)<=24&&C.loadSug()}if(S.hideWrap(),v.onHistoryInput(),b.onAdLinkInput(),n){if(13===t.which)return C.getCloseSugByEnter()&&C.setCloseSugByEnter(!1),void(C.getTranslatedByKeyDown()?C.setTranslatedByKeyDown(!1):h.onTranslate({transtype:"enter"}));
...
}function p(e,n){if(j.removeClass("with-loading-ocr-tip"),0!==e.errno||0===e.errno&&0===e.data.src.length){t("translation:widget/translate/input/clear").show(),w.set("shouldClearPromptOnInput",!0);
