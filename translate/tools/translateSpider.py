...
def crawl_word_means(word, sign, token, *, retry_times=3, charsets=('utf-8',)) -> dict:
...
def translate_spider(words: list) -> dict:
    ...
    for word in words:
        sign = js.call('e', word)
        # print(word, " : ", sign)
        word_means = crawl_word_means(word, sign, token, charsets=('utf-8', 'gbk', 'gb2312'))
        lst.update(word_means)
    return lst
